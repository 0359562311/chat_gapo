...
class ChatResponse {
  ...
  ChatResponse.fromJson(Map<String, dynamic> json)
      : data = (json['data'] as List?)
            ?.map((dynamic e) => ChatData.fromJson(e as Map<String, dynamic>))
            .toList(),
        total = json['total'] as int?;

  Map<String, dynamic> toJson() =>
      {'data': data?.map((e) => e.toJson()).toList(), 'total': total};
}
...
class LastMessage {
  ...
  LastMessage.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int?,
        ...
        rawBody = (json['raw_body'] as Map<String, dynamic>?) != null
            ? RawBody.fromJson(json['raw_body'] as Map<String, dynamic>)
            : null,
...
class Metadata {
  ...
  Metadata.fromJson(Map<String, dynamic> json)
      : authInformation =
            (json['auth_information'] as Map<String, dynamic>?) != null
                ? AuthInformation.fromJson(
                    json['auth_information'] as Map<String, dynamic>)
                : null;
